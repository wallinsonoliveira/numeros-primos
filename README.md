...
- Código em Python para retornar a lista de números primos de 1 a 10000
  ...
  print(primes)
  ```
- Teste 1: Fórmula *n² + n + 41* - [`Números Primos - Git - Teste 1.xlsx`](https://github.com/wallinsonoliveira/numeros-primos/raw/main/N%C3%BAmeros%20Primos%20-%20Git%20-%20Teste%201.xlsx). Essa expressão foi descoberta pelo matemático suíço *Leonhard Euler* no século XVIII. *Euler*, um dos matemáticos mais prolíficos da história, estudou essa fórmula e notou que ela gera números primos para valores inteiros de *n* entre *0* e *39*. Aprofundei um pouco mais nessa fórmula testando variações diversas. Substituí o valor *41* pela variável *P* e testei valores de P variando de -1000 a 1000 e n variando de *-300* a *300*. Constatei que o melhor resultado foi realmente o *P* valendo *41*. O rapaz *(Euler)* era mesmo um `gênio`.
...
- Teste 4: [`Números Primos - Git - Teste 4.xlsx`](https://github.com/wallinsonoliveira/numeros-primos/raw/main/N%C3%BAmeros%20Primos%20-%20Git%20-%20Teste%204.xlsx). - Fórmula *n² + n + 1* - Aqui listo vários números primos e vejo quais são detectados pela fórmula (coluna N). Depois calculo a quantidade de números entre os que são detectados (coluna P). Depois coloco todos esses espaçamentos na coluna R. Observe que existe um padrão de espaçamento, onde a distância aumenta incrementando 2 da distância anterior e, seguindo esse padrão, vai até a distância de 77, cujo número primo subsequênte e 1601. Portanto até esse número, usando essa ideia posso determinar números primos até o número 1601. Observe o gráfico.

### 🔢 Primo de Mersenne - Em breve
- Teste de Lucas-Lehmer

### 💰 Hipótese de Riemann
Recomendo o texto A hipótese de Riemann - 150 anos de José Carlos Santos, publicado na [`Gazeta de Matemática`](http://gazeta.spm.pt/) (nº158, 01/09/2009, pág. 8-14). Página do autor: [`Clique aqui`](https://www.fc.up.pt/mp/jcsantos/). Links do texto: 
[`Link 1`](http://gazeta.spm.pt/getArtigo?gid=243) - [`Link 2`](https://www.fc.up.pt/mp/jcsantos/PDF/artigos/Riemann_150.pdf) - [`Link 3`](https://github.com/wallinsonoliveira/numeros-primos/raw/main/Riemann_150.pdf)
